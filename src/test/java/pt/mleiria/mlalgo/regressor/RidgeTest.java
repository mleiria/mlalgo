...
public class RidgeTest extends TestCase {
    ...
    public void testRidgeFitInterceptFalse() {
    ...
    public void testRidgeFitInterceptTrue() {
        ...
        Ridge ridge = new Ridge(.5, true);
        ridge.fit(x, y);
        LOG.info(VUtils.showArrayContents(ridge.getThetas()));
        assertEquals(0.1, round(ridge.intercept(), 1));
